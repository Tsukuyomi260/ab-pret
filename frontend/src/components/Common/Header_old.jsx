        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div 
              ...
              className="lg:hidden fixed top-0 right-0 h-full w-1/3 bg-white shadow-2xl z-50 overflow-y-auto"
            >
              {/* Header du menu */}
              <div className="flex items-center justify-between p-4 border-b border-accent-200">
                <h2 className="text-lg font-semibold text-secondary-900 font-montserrat">
                  Menu
                </h2>
                <button
                  onClick={() => setMobileMenuOpen(false)}
