  ...
  const features = [
    {
      ...
      title: "Financement Nutrition",
      description: "Prêts spécialisés pour vos besoins nutritionnels et diététiques"
    },
    {
      icon: <Shield size={24} />,
    ...
    },
    {
      ...
      description: "Accompagnement personnalisé pour votre santé et nutrition"
    }
  ];
        ...
        <div className="relative px-4 lg:px-8 py-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                Santé et nutrition au cœur de nos préoccupations
              </motion.p>
              ...
              >
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-white/50 shadow-xl p-8 lg:p-12">
                  ...
                  <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                    Votre nutrition, notre priorité
                  </h2>
                  
                  <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    Nous développons des solutions innovantes pour prendre soin de votre santé 
                    et de votre nutrition. Des services personnalisés qui s'adaptent à vos besoins 
              ...
              >
                <p>© 2024 Campus Finance - AB Nutrition</p>
              </motion.div>
            </div>
          </div>
        </div>
