  ...
  const features = [
    {
      ...
      title: "Financement Médical",
      description: "Prêts spécialisés pour vos soins de santé et traitements médicaux"
    },
    {
      icon: <Shield size={24} />,
    ...
    },
    {
      ...
      description: "Accompagnement personnalisé pour votre santé et bien-être"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-pink-500 via-rose-600 to-red-600 opacity-10"></div>
        ...
        <div className="relative px-4 lg:px-8 py-6">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <span className="text-sm font-medium text-pink-700">Retour au menu</span>
            </motion.button>
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <motion.div
                ...
                className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-600 rounded-full shadow-lg mb-8"
              >
              ...
              >
                Santé et bien-être au cœur de nos préoccupations
              </motion.p>
              ...
              >
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-white/50 shadow-xl p-8 lg:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    Nous développons des solutions innovantes pour prendre soin de votre santé 
                    et de votre bien-être. Des services personnalisés qui s'adaptent à vos besoins 
                    et vous accompagnent dans votre parcours de santé.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {features.map((feature, index) => (
                    ...
                    >
                      <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-pink-500 to-rose-600 rounded-xl mb-4 mx-auto">
              ...
              <motion.div
                ...
                className="mb-8"
              >
                <button className="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-pink-600 to-rose-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                  <Bell size={20} />
              ...
              >
                <p>© 2024 Campus Finance - AB Bien-Être</p>
              </motion.div>
            </div>
          </div>
        </div>
